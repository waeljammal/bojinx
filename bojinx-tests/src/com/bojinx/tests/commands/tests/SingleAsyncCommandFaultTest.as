package com.bojinx.tests.commands.tests
{
	...
	public class SingleAsyncCommandFaultTest
	{
		...
		public function SingleAsyncCommandFaultTest()
		{
		...
		public function testCombinedCommands():void
		{
			...
			bus.addListener( asyncListenerHandlerOne, CommandMessage, CommandMessage.FAULT );
			
			bus.dispatch( new CommandMessage(), CommandMessage.FAULT );
		}
		...
		protected function handleListenerOne( message:CommandMessage ):void
		{
			...
			assertTrue( message.value.result == "fault" );
		}
	}
}
