...
package org.as3commons.stageprocessing.impl
{
	 ...
	 * @author Roland Zwaga
	 */
	public class StageObjectProcessor implements IStageObjectProcessorRegistry
	{
		/*============================================================================*/
		/*= PUBLIC PROPERTIES                                                         */
		/*============================================================================*/
		 ...
		 * Changed by Wael
		 */
		protected static const LOGGER:Logger = LoggingContext.getLogger( StageObjectProcessor );
